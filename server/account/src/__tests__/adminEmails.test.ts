...
function loadAdmin (envValue: string | undefined): AdminModule {
  ...
  jest.isolateModules(() => {
    ...
    mod = require('../admin') as AdminModule
  })
...
describe('admin.ts — env parsing + lookup normalization', () => {
  ...
  test('4b. invalid-shape WARN via injected logger', () => {
